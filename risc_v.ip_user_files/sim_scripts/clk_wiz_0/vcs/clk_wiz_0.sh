...
#
# Script generated by Vivado on Wed Jul 08 14:45:53 BST 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../../../../../tools/Xilinx/2025.2/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/vishnu/Documents/Vivado_Projects/risc_v/risc_v.cache/compile_simlib/vcs"
  fi
